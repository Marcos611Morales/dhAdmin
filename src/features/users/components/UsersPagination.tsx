 ...
 *
 * Muestra: "Page X of Y" + total de elementos + botones prev/next.
 * Los botones se deshabilitan en los extremos (primera/última página).
 */
export function UsersPagination({ page, totalPages, total, onPageChange }: UsersPaginationProps) {
  if (totalPages <= 0) return null

  return (
    <div className="flex items-center justify-between">
      <p className="text-sm text-gray-500">
        <span className="font-medium text-navy">{total.toLocaleString('en-US')}</span> total users
      </p>
